    ...
    <div class="d-flex">
        <div class="dropdown" style="margin-right: 15px;">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <li>
                    <a href="index.php?quanli=luot-ban-theo-ngay&type_chart=bar" class="dropdown-item">Bar Chart</a>
                </li>
                <li>
                    <a href="index.php?quanli=luot-ban-theo-ngay&type_chart=line" class="dropdown-item">Line Chart</a>
                </li>
                <li>
                    <a href="index.php?quanli=luot-ban-theo-ngay&type_chart=doughnut" class="dropdown-item">Doughnut</a>
                </li>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <li>
                    <a href="index.php?quanli=luot-ban-theo-ngay&limit_day=100" class="dropdown-item">Xem tất cả</a>
                </li>
                <li>
                    <a href="index.php?quanli=luot-ban-theo-ngay&limit_day=7" class="dropdown-item">7 ngày</a>
                </li>
                <li>
                    <a href="index.php?quanli=luot-ban-theo-ngay&limit_day=14" class="dropdown-item">14 ngày</a>
                </li>
                <li>
                    <a href="index.php?quanli=luot-ban-theo-ngay&limit_day=21" class="dropdown-item">21 ngày</a>
                </li>
                <li>
