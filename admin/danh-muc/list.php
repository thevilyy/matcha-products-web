...
<div class="container-fluid pt-4 px-4">
    <div class="bg-light text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <a href="index.php?quanli=them-danh-muc" class="btn btn-custom"><i class="fa fa-plus"></i> Thêm danh mục</a>
                        ...
                        <td>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu p-0">
                                    ...
                                    <a class="dropdown-item text-danger" href="index.php?quanli=danh-sach-danh-muc&xoa=<?=$cate_id?>&qty_pd=<?=$qty_product?>">
                                        Xóa
                                    </a>
                                </div>
                            </div>
