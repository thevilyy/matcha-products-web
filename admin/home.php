...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        ...
        <div class="col-sm-6 col-xl-3">
            <a href="index.php?quanli=danh-sach-san-pham" class="bg-light rounded d-flex align-items-center justify-content-between p-4">
        ...
        <div class="col-sm-6 col-xl-3">
            <a href="index.php?quanli=danh-sach-don-cho" class="bg-light rounded d-flex align-items-center justify-content-between p-4">
