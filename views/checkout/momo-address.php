            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="d-flex">
                                <a href="index.php?url=thanh-toan-momo" class="btn btn-outline-dark block mr-1">Nhập địa chỉ khác</a>
                                <?php
                                    $address = $AddressModel->select_address_user($_SESSION['user']['id']);

                                    if(is_array($address)) {
                                ?>
                                <a href="index.php?url=thanh-toan-momo-address-2" class="btn btn-outline-dark ">Địa chỉ 2</a>
                                <?php
                                    }
                                ?>
