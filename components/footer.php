        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-7">
                <div class="footer__about">
                    <div class="footer__logo">
                        <a href="index.php?url=trang-chu"><img style="max-height: 70px;" src="upload/matcha-logo.png" alt=""></a>
                    </div>
                    <p>Chào mừng bạn đến với The Matcha Shop nơi cung cấp trà xanh chất lượng</p>
            ...
            <div class="col-lg-2 col-md-3 col-sm-5">
                <div class="footer__widget">
                    <h6>ĐƯỜNG DẪN</h6>
                    <ul>
                        <li><a href="index.php?url=trang-chu">Về chúng tôi</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="footer__copyright__text">
                    <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">SONG VI</a></p>
                </div>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </div>
        </div>
